...
export default class Analysis extends React.Component {
  ...
  componentDidMount() {
    this.setState({
      anchorY: this.calculateAnchorY(this.state.optionIndex),
    });
  }

  calculateAnchorY(optionIndex) {
  ...
  handleHoverOption = (optionIndex) => () => {
    this.setState({
      optionIndex,
      anchorY: this.calculateAnchorY(optionIndex),
    });
  }
  ...
  render() {
    const { optionIndex, anchorY } = this.state;
                ...
                <div className="options-content">
                  {options.map((option, index) => (
                    <div
                      ...
                      onMouseOver={this.handleHoverOption(index)}
